...
VALUES
    (044525974, 'Тинькофф Кредит наличными, без залога', 'https://www.tinkoff.ru/loans/cash-loan/', true, 643, 50000, 5000000, 3, 50.00, 0),
    ...
    (044525974, 'Тинькофф Кредит наличными, под залог автомобиля', 'https://www.tinkoff.ru/loans/cash-loan/auto/', true, 643, 100000, 7000000, 3, 50.00, 1),
    (044525974, 'Тинькофф Кредит наличными, под залог автомобиля', 'https://www.tinkoff.ru/loans/cash-loan/auto/', true, 643, 100000, 7000000, 6, 43.15, 1),
    (044525974, 'Тинькофф Кредит наличными, под залог автомобиля', 'https://www.tinkoff.ru/loans/cash-loan/auto/', true, 643, 100000, 7000000, 12, 36.30, 1),
    (044525974, 'Тинькофф Кредит наличными, под залог автомобиля', 'https://www.tinkoff.ru/loans/cash-loan/auto/', true, 643, 100000, 7000000, 24, 29.45, 1),
    (044525974, 'Тинькофф Кредит наличными, под залог автомобиля', 'https://www.tinkoff.ru/loans/cash-loan/auto/', true, 643, 100000, 7000000, 36, 22.60, 1),
    (044525974, 'Тинькофф Кредит наличными, под залог автомобиля', 'https://www.tinkoff.ru/loans/cash-loan/auto/', true, 643, 100000, 7000000, 48, 15.75, 1),
    (044525974, 'Тинькофф Кредит наличными, под залог автомобиля', 'https://www.tinkoff.ru/loans/cash-loan/auto/', true, 643, 100000, 7000000, 60, 8.90, 1),

    (044525187, 'ВТБ Кредит наличными, без заключения договора страхования, без услуги "Ваша низкая ставка"', 'https://www.vtb.ru/personal/kredit/nalichnymi/', true, 643, 30000, 100000, 6, 51.20, 0),
    ...
    (044525187, 'ВТБ Кредит наличными, без заключения договора страхования, без услуги "Ваша низкая ставка"', 'https://www.vtb.ru/personal/kredit/nalichnymi/', true, 643, 100001, 299999, 6, 44.20, 0),
    ...
    (044525187, 'ВТБ Кредит наличными, без заключения договора страхования, без услуги "Ваша низкая ставка"', 'https://www.vtb.ru/personal/kredit/nalichnymi/', true, 643, 300000, 999999, 6, 39.20, 0),
    ...
    (044525187, 'ВТБ Кредит наличными, без заключения договора страхования, без услуги "Ваша низкая ставка"', 'https://www.vtb.ru/personal/kredit/nalichnymi/', true, 643, 1000000, 7000000, 6, 39.20, 0),
    ...
    (044525187, 'ВТБ Кредит наличными, без заключения договора страхования, без услуги "Ваша низкая ставка"', 'https://www.vtb.ru/personal/kredit/nalichnymi/', true, 643, 7000001, 40000000, 6, 39.20, 0),
    ...
    (044525823, 'Газпромбанк Кредит наличными', 'https://www.gazprombank.ru/personal/take_credit/consumer_credit/5004451/', true, 643, 10000, 7000000, 13, 24.40, 0),
    ...
    (044525593, 'Альфа-банк Кредит наличными', 'https://alfabank.ru/get-money/credit/credit-cash/', true, 643, 100000, 15000000, 12, 34.99, 0),
    ...
    (044525111, 'Россельхозбанк Кредит без залога и поручительства, иные физические лица', 'https://www.rshb.ru/natural/loans/all-goals', true, 643, 30000, 299999, 13, 21.50, 0),
    ...
    (044525111, 'Россельхозбанк Кредит без залога и поручительства, иные физические лица', 'https://www.rshb.ru/natural/loans/all-goals', true, 643, 300000, 999999, 13, 18.50, 0),
    ...
    (044525111, 'Россельхозбанк Кредит без залога и поручительства, иные физические лица', 'https://www.rshb.ru/natural/loans/all-goals', true, 643, 1000000, 2499999, 13, 18.50, 0),
    ...
    (044525111, 'Россельхозбанк Кредит без залога и поручительства, иные физические лица', 'https://www.rshb.ru/natural/loans/all-goals', true, 643, 2500000, 5000000, 13, 16.50, 0),
    ...
    (044525225, 'Сбербанк Кредит на любые цели, общие условия', 'https://www.sberbank.com/ru/person/credits/money/consumer_unsecured', true, 643, 10000, 299999, 3, 34.90, 0),
    ...
    (044525225, 'Сбербанк Кредит на любые цели, общие условия', 'https://www.sberbank.com/ru/person/credits/money/consumer_unsecured', true, 643, 300000, 999999, 3, 27.90, 0),
    ...
    (044525225, 'Сбербанк Кредит на любые цели, общие условия', 'https://www.sberbank.com/ru/person/credits/money/consumer_unsecured', true, 643, 1000000, 30000000, 3, 24.90, 0),
    ...
    (044525225, 'Сбербанк Кредит на совершённую покупку', 'http://www.sberbank.ru/ru/person/credits/money/sovershennuyu_pokupku', true, 643, 3000, 300000, 3, 29.90, 1),
    (044525225, 'Сбербанк Кредит на совершённую покупку', 'http://www.sberbank.ru/ru/person/credits/money/sovershennuyu_pokupku', true, 643, 1000000, 30000000, 6, 24.98, 1),
    (044525225, 'Сбербанк Кредит на совершённую покупку', 'http://www.sberbank.ru/ru/person/credits/money/sovershennuyu_pokupku', true, 643, 1000000, 30000000, 9, 20.06, 1),
    (044525225, 'Сбербанк Кредит на совершённую покупку', 'http://www.sberbank.ru/ru/person/credits/money/sovershennuyu_pokupku', true, 643, 1000000, 30000000, 12, 15.14, 1),
    (044525225, 'Сбербанк Кредит на совершённую покупку', 'http://www.sberbank.ru/ru/person/credits/money/sovershennuyu_pokupku', true, 643, 1000000, 30000000, 24, 10.22, 1),
    (044525225, 'Сбербанк Кредит на совершённую покупку', 'http://www.sberbank.ru/ru/person/credits/money/sovershennuyu_pokupku', true, 643, 1000000, 30000000, 36, 5.30, 1);
