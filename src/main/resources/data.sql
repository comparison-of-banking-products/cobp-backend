...
VALUES
    (044525974, 'Тинькофф Банк', 'АО "Тинькофф Банк"', 'Онлайн-экосистема, основанная на финансовых и лайфстайл-услугах', 'tinkoff-logo.png', 'https://www.tinkoff.ru'),
    (044525187, 'Банк ВТБ', 'ПАО "Банк ВТБ"', 'Системообразующий универсальный российский банк', 'vtb-logo.png', 'https://www.vtb.ru'),
    (044525823, 'Газпромбанк', 'АО "Газпромбанк"', 'Один из крупнейших универсальных финансовых институтов России', 'gazprombank-logo.png', 'https://www.gazprombank.ru'),
    (044525593, 'Альфа-Банк', 'АО "Альфа-Банк"', 'Крупнейший частный банк в России', 'alfabank-logo.png', 'https://alfabank.ru'),
    (044525111, 'Россельхозбанк', 'АО "Российский Cельскохозяйственный банк"', 'Универсальный коммерческий банк, лидер в финансировании агропромышленного комплекса России', 'rshb-logo.png', 'https://www.rshb.ru'),
    (044525225, 'Сбербанк', 'ПАО "Сбербанк России"', 'Российский финансовый конгломерат, крупнейший универсальный банк', 'sberbank-logo.png', 'https://www.sberbank.ru');
...
VALUES
    (044525974, 'Тинькофф Кредит наличными, без залога', 'https://www.tinkoff.ru/loans/cash-loan/', true, 643, 50000, 5000000, 3, 50.00),
    (044525974, 'Тинькофф Кредит наличными, без залога', 'https://www.tinkoff.ru/loans/cash-loan/', true, 643, 50000, 5000000, 6, 43.15),
    (044525974, 'Тинькофф Кредит наличными, без залога', 'https://www.tinkoff.ru/loans/cash-loan/', true, 643, 50000, 5000000, 12, 36.30),
    (044525974, 'Тинькофф Кредит наличными, без залога', 'https://www.tinkoff.ru/loans/cash-loan/', true, 643, 50000, 5000000, 24, 29.45),
    (044525974, 'Тинькофф Кредит наличными, без залога', 'https://www.tinkoff.ru/loans/cash-loan/', true, 643, 50000, 5000000, 36, 22.60),
    (044525974, 'Тинькофф Кредит наличными, без залога', 'https://www.tinkoff.ru/loans/cash-loan/', true, 643, 50000, 5000000, 48, 15.75),
    (044525974, 'Тинькофф Кредит наличными, без залога', 'https://www.tinkoff.ru/loans/cash-loan/', true, 643, 50000, 5000000, 60, 8.90),

    (044525187, 'ВТБ Кредит наличными, без заключения договора страхования, без услуги "Ваша низкая ставка"', 'https://www.vtb.ru/personal/kredit/nalichnymi/', true, 643, 30000, 100000, 6, 51.20),
    (044525187, 'ВТБ Кредит наличными, без заключения договора страхования, без услуги "Ваша низкая ставка"', 'https://www.vtb.ru/personal/kredit/nalichnymi/', true, 643, 30000, 100000, 12, 45.34),
    (044525187, 'ВТБ Кредит наличными, без заключения договора страхования, без услуги "Ваша низкая ставка"', 'https://www.vtb.ru/personal/kredit/nalichnymi/', true, 643, 30000, 100000, 24, 39.48),
    (044525187, 'ВТБ Кредит наличными, без заключения договора страхования, без услуги "Ваша низкая ставка"', 'https://www.vtb.ru/personal/kredit/nalichnymi/', true, 643, 30000, 100000, 36, 33.62),
    (044525187, 'ВТБ Кредит наличными, без заключения договора страхования, без услуги "Ваша низкая ставка"', 'https://www.vtb.ru/personal/kredit/nalichnymi/', true, 643, 30000, 100000, 48, 27.76),
    (044525187, 'ВТБ Кредит наличными, без заключения договора страхования, без услуги "Ваша низкая ставка"', 'https://www.vtb.ru/personal/kredit/nalichnymi/', true, 643, 30000, 100000, 60, 21.90),

    (044525187, 'ВТБ Кредит наличными, без заключения договора страхования, без услуги "Ваша низкая ставка"', 'https://www.vtb.ru/personal/kredit/nalichnymi/', true, 643, 100001, 299999, 6, 44.20),
    (044525187, 'ВТБ Кредит наличными, без заключения договора страхования, без услуги "Ваша низкая ставка"', 'https://www.vtb.ru/personal/kredit/nalichnymi/', true, 643, 100001, 299999, 12, 38.62),
    (044525187, 'ВТБ Кредит наличными, без заключения договора страхования, без услуги "Ваша низкая ставка"', 'https://www.vtb.ru/personal/kredit/nalichnymi/', true, 643, 100001, 299999, 24, 33.04),
    (044525187, 'ВТБ Кредит наличными, без заключения договора страхования, без услуги "Ваша низкая ставка"', 'https://www.vtb.ru/personal/kredit/nalichnymi/', true, 643, 100001, 299999, 36, 27.46),
    (044525187, 'ВТБ Кредит наличными, без заключения договора страхования, без услуги "Ваша низкая ставка"', 'https://www.vtb.ru/personal/kredit/nalichnymi/', true, 643, 100001, 299999, 48, 21.88),
    (044525187, 'ВТБ Кредит наличными, без заключения договора страхования, без услуги "Ваша низкая ставка"', 'https://www.vtb.ru/personal/kredit/nalichnymi/', true, 643, 100001, 299999, 60, 16.30),

    (044525187, 'ВТБ Кредит наличными, без заключения договора страхования, без услуги "Ваша низкая ставка"', 'https://www.vtb.ru/personal/kredit/nalichnymi/', true, 643, 300000, 999999, 6, 39.20),
    (044525187, 'ВТБ Кредит наличными, без заключения договора страхования, без услуги "Ваша низкая ставка"', 'https://www.vtb.ru/personal/kredit/nalichnymi/', true, 643, 300000, 999999, 12, 34.62),
    (044525187, 'ВТБ Кредит наличными, без заключения договора страхования, без услуги "Ваша низкая ставка"', 'https://www.vtb.ru/personal/kredit/nalichnymi/', true, 643, 300000, 999999, 24, 30.04),
    (044525187, 'ВТБ Кредит наличными, без заключения договора страхования, без услуги "Ваша низкая ставка"', 'https://www.vtb.ru/personal/kredit/nalichnymi/', true, 643, 300000, 999999, 36, 25.46),
    (044525187, 'ВТБ Кредит наличными, без заключения договора страхования, без услуги "Ваша низкая ставка"', 'https://www.vtb.ru/personal/kredit/nalichnymi/', true, 643, 300000, 999999, 48, 20.88),
    (044525187, 'ВТБ Кредит наличными, без заключения договора страхования, без услуги "Ваша низкая ставка"', 'https://www.vtb.ru/personal/kredit/nalichnymi/', true, 643, 300000, 999999, 60, 16.30),

    (044525187, 'ВТБ Кредит наличными, без заключения договора страхования, без услуги "Ваша низкая ставка"', 'https://www.vtb.ru/personal/kredit/nalichnymi/', true, 643, 1000000, 7000000, 6, 39.20),
    (044525187, 'ВТБ Кредит наличными, без заключения договора страхования, без услуги "Ваша низкая ставка"', 'https://www.vtb.ru/personal/kredit/nalichnymi/', true, 643, 1000000, 7000000, 12, 34.22),
    (044525187, 'ВТБ Кредит наличными, без заключения договора страхования, без услуги "Ваша низкая ставка"', 'https://www.vtb.ru/personal/kredit/nalichnymi/', true, 643, 1000000, 7000000, 24, 29.24),
    (044525187, 'ВТБ Кредит наличными, без заключения договора страхования, без услуги "Ваша низкая ставка"', 'https://www.vtb.ru/personal/kredit/nalichnymi/', true, 643, 1000000, 7000000, 36, 24.26),
    (044525187, 'ВТБ Кредит наличными, без заключения договора страхования, без услуги "Ваша низкая ставка"', 'https://www.vtb.ru/personal/kredit/nalichnymi/', true, 643, 1000000, 7000000, 48, 19.28),
    (044525187, 'ВТБ Кредит наличными, без заключения договора страхования, без услуги "Ваша низкая ставка"', 'https://www.vtb.ru/personal/kredit/nalichnymi/', true, 643, 1000000, 7000000, 60, 14.30),

    (044525187, 'ВТБ Кредит наличными, без заключения договора страхования, без услуги "Ваша низкая ставка"', 'https://www.vtb.ru/personal/kredit/nalichnymi/', true, 643, 7000001, 40000000, 6, 39.20),
    (044525187, 'ВТБ Кредит наличными, без заключения договора страхования, без услуги "Ваша низкая ставка"', 'https://www.vtb.ru/personal/kredit/nalichnymi/', true, 643, 7000001, 40000000, 12, 34.18),
    (044525187, 'ВТБ Кредит наличными, без заключения договора страхования, без услуги "Ваша низкая ставка"', 'https://www.vtb.ru/personal/kredit/nalichnymi/', true, 643, 7000001, 40000000, 24, 29.16),
    (044525187, 'ВТБ Кредит наличными, без заключения договора страхования, без услуги "Ваша низкая ставка"', 'https://www.vtb.ru/personal/kredit/nalichnymi/', true, 643, 7000001, 40000000, 36, 24.14),
    (044525187, 'ВТБ Кредит наличными, без заключения договора страхования, без услуги "Ваша низкая ставка"', 'https://www.vtb.ru/personal/kredit/nalichnymi/', true, 643, 7000001, 40000000, 48, 19.12),
    (044525187, 'ВТБ Кредит наличными, без заключения договора страхования, без услуги "Ваша низкая ставка"', 'https://www.vtb.ru/personal/kredit/nalichnymi/', true, 643, 7000001, 40000000, 60, 14.10),

    (044525823, 'Газпромбанк Кредит наличными', 'https://www.gazprombank.ru/personal/take_credit/consumer_credit/5004451/', true, 643, 10000, 7000000, 13, 24.40),
    (044525823, 'Газпромбанк Кредит наличными', 'https://www.gazprombank.ru/personal/take_credit/consumer_credit/5004451/', true, 643, 10000, 7000000, 24, 20.98),
    (044525823, 'Газпромбанк Кредит наличными', 'https://www.gazprombank.ru/personal/take_credit/consumer_credit/5004451/', true, 643, 10000, 7000000, 36, 17.56),
    ...
    (044525593, 'Альфа-банк Кредит наличными', 'https://alfabank.ru/get-money/credit/credit-cash/', true, 643, 100000, 15000000, 36, 28.10),
    (044525593, 'Альфа-банк Кредит наличными', 'https://alfabank.ru/get-money/credit/credit-cash/', true, 643, 100000, 15000000, 48, 24.66),
    (044525593, 'Альфа-банк Кредит наличными', 'https://alfabank.ru/get-money/credit/credit-cash/', true, 643, 100000, 15000000, 60, 21.22),
    (044525593, 'Альфа-банк Кредит наличными', 'https://alfabank.ru/get-money/credit/credit-cash/', true, 643, 100000, 15000000, 72, 17.77),
    (044525593, 'Альфа-банк Кредит наличными', 'https://alfabank.ru/get-money/credit/credit-cash/', true, 643, 100000, 15000000, 84, 14.33),
    (044525593, 'Альфа-банк Кредит наличными', 'https://alfabank.ru/get-money/credit/credit-cash/', true, 643, 100000, 15000000, 96, 10.89),
    (044525593, 'Альфа-банк Кредит наличными', 'https://alfabank.ru/get-money/credit/credit-cash/', true, 643, 100000, 15000000, 108, 7.44),
    (044525593, 'Альфа-банк Кредит наличными', 'https://alfabank.ru/get-money/credit/credit-cash/', true, 643, 100000, 15000000, 120, 4.00),

    (044525111, 'Россельхозбанк Кредит без залога и поручительства, иные физические лица', 'https://www.rshb.ru/natural/loans/all-goals', true, 643, 30000, 299999, 13, 21.50),
    (044525111, 'Россельхозбанк Кредит без залога и поручительства, иные физические лица', 'https://www.rshb.ru/natural/loans/all-goals', true, 643, 30000, 299999, 24, 20.15),
    (044525111, 'Россельхозбанк Кредит без залога и поручительства, иные физические лица', 'https://www.rshb.ru/natural/loans/all-goals', true, 643, 30000, 299999, 36, 18.80),
    (044525111, 'Россельхозбанк Кредит без залога и поручительства, иные физические лица', 'https://www.rshb.ru/natural/loans/all-goals', true, 643, 30000, 299999, 48, 17.45),
    (044525111, 'Россельхозбанк Кредит без залога и поручительства, иные физические лица', 'https://www.rshb.ru/natural/loans/all-goals', true, 643, 30000, 299999, 60, 16.10),

    (044525111, 'Россельхозбанк Кредит без залога и поручительства, иные физические лица', 'https://www.rshb.ru/natural/loans/all-goals', true, 643, 300000, 999999, 13, 18.50),
    (044525111, 'Россельхозбанк Кредит без залога и поручительства, иные физические лица', 'https://www.rshb.ru/natural/loans/all-goals', true, 643, 300000, 999999, 24, 17.90),
    (044525111, 'Россельхозбанк Кредит без залога и поручительства, иные физические лица', 'https://www.rshb.ru/natural/loans/all-goals', true, 643, 300000, 999999, 36, 17.30),
    (044525111, 'Россельхозбанк Кредит без залога и поручительства, иные физические лица', 'https://www.rshb.ru/natural/loans/all-goals', true, 643, 300000, 999999, 48, 16.70),
    (044525111, 'Россельхозбанк Кредит без залога и поручительства, иные физические лица', 'https://www.rshb.ru/natural/loans/all-goals', true, 643, 300000, 999999, 60, 16.10),

    (044525111, 'Россельхозбанк Кредит без залога и поручительства, иные физические лица', 'https://www.rshb.ru/natural/loans/all-goals', true, 643, 1000000, 2499999, 13, 18.50),
    (044525111, 'Россельхозбанк Кредит без залога и поручительства, иные физические лица', 'https://www.rshb.ru/natural/loans/all-goals', true, 643, 1000000, 2499999, 24, 17.75),
    (044525111, 'Россельхозбанк Кредит без залога и поручительства, иные физические лица', 'https://www.rshb.ru/natural/loans/all-goals', true, 643, 1000000, 2499999, 36, 17.00),
    (044525111, 'Россельхозбанк Кредит без залога и поручительства, иные физические лица', 'https://www.rshb.ru/natural/loans/all-goals', true, 643, 1000000, 2499999, 48, 16.25),
    (044525111, 'Россельхозбанк Кредит без залога и поручительства, иные физические лица', 'https://www.rshb.ru/natural/loans/all-goals', true, 643, 1000000, 2499999, 60, 15.50),

    (044525111, 'Россельхозбанк Кредит без залога и поручительства, иные физические лица', 'https://www.rshb.ru/natural/loans/all-goals', true, 643, 2500000, 5000000, 13, 16.50),
    (044525111, 'Россельхозбанк Кредит без залога и поручительства, иные физические лица', 'https://www.rshb.ru/natural/loans/all-goals', true, 643, 2500000, 5000000, 24, 16.25),
    (044525111, 'Россельхозбанк Кредит без залога и поручительства, иные физические лица', 'https://www.rshb.ru/natural/loans/all-goals', true, 643, 2500000, 5000000, 36, 16.00),
    (044525111, 'Россельхозбанк Кредит без залога и поручительства, иные физические лица', 'https://www.rshb.ru/natural/loans/all-goals', true, 643, 2500000, 5000000, 48, 17.75),
    (044525111, 'Россельхозбанк Кредит без залога и поручительства, иные физические лица', 'https://www.rshb.ru/natural/loans/all-goals', true, 643, 2500000, 5000000, 60, 15.50),

    (044525225, 'Сбербанк Кредит на любые цели, общие условия', 'https://www.sberbank.com/ru/person/credits/money/consumer_unsecured', true, 643, 10000, 299999, 3, 34.90),
    (044525225, 'Сбербанк Кредит на любые цели, общие условия', 'https://www.sberbank.com/ru/person/credits/money/consumer_unsecured', true, 643, 10000, 299999, 6, 33.00),
    (044525225, 'Сбербанк Кредит на любые цели, общие условия', 'https://www.sberbank.com/ru/person/credits/money/consumer_unsecured', true, 643, 10000, 299999, 9, 31.05),
    (044525225, 'Сбербанк Кредит на любые цели, общие условия', 'https://www.sberbank.com/ru/person/credits/money/consumer_unsecured', true, 643, 10000, 299999, 12, 29.13),
    (044525225, 'Сбербанк Кредит на любые цели, общие условия', 'https://www.sberbank.com/ru/person/credits/money/consumer_unsecured', true, 643, 10000, 299999, 13, 27.20),
    (044525225, 'Сбербанк Кредит на любые цели, общие условия', 'https://www.sberbank.com/ru/person/credits/money/consumer_unsecured', true, 643, 10000, 299999, 24, 25.28),
    (044525225, 'Сбербанк Кредит на любые цели, общие условия', 'https://www.sberbank.com/ru/person/credits/money/consumer_unsecured', true, 643, 10000, 299999, 36, 23.35),
    (044525225, 'Сбербанк Кредит на любые цели, общие условия', 'https://www.sberbank.com/ru/person/credits/money/consumer_unsecured', true, 643, 10000, 299999, 48, 21.43),
    (044525225, 'Сбербанк Кредит на любые цели, общие условия', 'https://www.sberbank.com/ru/person/credits/money/consumer_unsecured', true, 643, 10000, 299999, 60, 19.50),

    (044525225, 'Сбербанк Кредит на любые цели, общие условия', 'https://www.sberbank.com/ru/person/credits/money/consumer_unsecured', true, 643, 300000, 999999, 3, 27.90),
    (044525225, 'Сбербанк Кредит на любые цели, общие условия', 'https://www.sberbank.com/ru/person/credits/money/consumer_unsecured', true, 643, 300000, 999999, 6, 26.60),
    (044525225, 'Сбербанк Кредит на любые цели, общие условия', 'https://www.sberbank.com/ru/person/credits/money/consumer_unsecured', true, 643, 300000, 999999, 9, 25.30),
    (044525225, 'Сбербанк Кредит на любые цели, общие условия', 'https://www.sberbank.com/ru/person/credits/money/consumer_unsecured', true, 643, 300000, 999999, 12, 24.00),
    (044525225, 'Сбербанк Кредит на любые цели, общие условия', 'https://www.sberbank.com/ru/person/credits/money/consumer_unsecured', true, 643, 300000, 999999, 13, 22.70),
    (044525225, 'Сбербанк Кредит на любые цели, общие условия', 'https://www.sberbank.com/ru/person/credits/money/consumer_unsecured', true, 643, 300000, 999999, 24, 21.40),
    (044525225, 'Сбербанк Кредит на любые цели, общие условия', 'https://www.sberbank.com/ru/person/credits/money/consumer_unsecured', true, 643, 300000, 999999, 36, 20.10),
    (044525225, 'Сбербанк Кредит на любые цели, общие условия', 'https://www.sberbank.com/ru/person/credits/money/consumer_unsecured', true, 643, 300000, 999999, 48, 18.80),
    (044525225, 'Сбербанк Кредит на любые цели, общие условия', 'https://www.sberbank.com/ru/person/credits/money/consumer_unsecured', true, 643, 300000, 999999, 60, 17.50),

    (044525225, 'Сбербанк Кредит на любые цели, общие условия', 'https://www.sberbank.com/ru/person/credits/money/consumer_unsecured', true, 643, 1000000, 30000000, 3, 24.90),
    (044525225, 'Сбербанк Кредит на любые цели, общие условия', 'https://www.sberbank.com/ru/person/credits/money/consumer_unsecured', true, 643, 1000000, 30000000, 6, 23.90),
    (044525225, 'Сбербанк Кредит на любые цели, общие условия', 'https://www.sberbank.com/ru/person/credits/money/consumer_unsecured', true, 643, 1000000, 30000000, 9, 22.90),
    (044525225, 'Сбербанк Кредит на любые цели, общие условия', 'https://www.sberbank.com/ru/person/credits/money/consumer_unsecured', true, 643, 1000000, 30000000, 12, 21.90),
    (044525225, 'Сбербанк Кредит на любые цели, общие условия', 'https://www.sberbank.com/ru/person/credits/money/consumer_unsecured', true, 643, 1000000, 30000000, 13, 20.90),
    (044525225, 'Сбербанк Кредит на любые цели, общие условия', 'https://www.sberbank.com/ru/person/credits/money/consumer_unsecured', true, 643, 1000000, 30000000, 24, 19.90),
    (044525225, 'Сбербанк Кредит на любые цели, общие условия', 'https://www.sberbank.com/ru/person/credits/money/consumer_unsecured', true, 643, 1000000, 30000000, 36, 18.90),
    (044525225, 'Сбербанк Кредит на любые цели, общие условия', 'https://www.sberbank.com/ru/person/credits/money/consumer_unsecured', true, 643, 1000000, 30000000, 48, 17.90),
    (044525225, 'Сбербанк Кредит на любые цели, общие условия', 'https://www.sberbank.com/ru/person/credits/money/consumer_unsecured', true, 643, 1000000, 30000000, 60, 16.90);
