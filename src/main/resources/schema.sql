...
CREATE TABLE IF NOT EXISTS credits (
	...
	banks_bic				BIGINT 			NOT NULL,
 	FOREIGN KEY (banks_bic) REFERENCES banks(bic),
	name					VARCHAR(100) 	NOT NULL,
	is_active				BOOLEAN			NOT NULL,
	currencies_num  		INT				NOT NULL, 	
	FOREIGN KEY (currencies_num) REFERENCES currencies(num),	
...
CREATE TABLE IF NOT EXISTS deposit_rates (
    ...
    FOREIGN KEY (deposits_id) REFERENCES deposits(id),
	rate					FLOAT           NOT NULL,		
	min_ammount 		    INT             NOT NULL,
	max_ammount 		    INT				NOT NULL,
	min_period				INT             NOT NULL,
